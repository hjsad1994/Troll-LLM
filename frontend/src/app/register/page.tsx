...
import { REGISTRATION_ENABLED, registrationDisabled, Language } from '@/lib/i18n'

function RegistrationDisabledMessage({ language }: { language: 'en' | 'vi' }) {
  const msg = registrationDisabled[language]
  return (
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-indigo-500 text-white font-semibold hover:bg-indigo-600 transition-colors"
        >
          {msg.backToHome}
        </Link>
      </div>
...
function RegisterForm() {
  ...
  // Show registration disabled message if registration is not enabled
  if (!REGISTRATION_ENABLED) {
    return <RegistrationDisabledMessage language={language as Language} />
  }
