...
export default function ModelsPage() {
  ...
  useEffect(() => {
    ...
    const fallbackModels: ApiModel[] = [
      ...
      { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash Preview', type: 'openhands', reasoning: 'high', inputPricePerMTok: 0.5, outputPricePerMTok: 3.0, cacheWritePricePerMTok: 0, cacheHitPricePerMTok: 0.5, billingMultiplier: 1.05 },
