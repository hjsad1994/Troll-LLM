        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 opacity-0 animate-fade-in-up animation-delay-200">
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10">
            ...
            <span className="text-[var(--theme-text-muted)] text-sm">
              <span className="font-semibold text-purple-600 dark:text-purple-400">{stats.available}</span> {t.ohmygptBackupKeys?.readyForRotation || 'keys ready for auto-rotation'}
            </span>
          </div>
          <button
            onClick={() => setCreateModal(true)}
            className="px-5 py-2.5 rounded-lg bg-purple-600 dark:bg-purple-500 text-white font-medium text-sm hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors flex items-center gap-2"
          >
