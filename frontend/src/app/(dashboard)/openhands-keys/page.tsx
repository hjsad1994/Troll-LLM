                ...
                <tr>
                  <td colSpan={6} className="text-center py-12">
                    <div className="flex items-center justify-center gap-3">
                      <div className="w-4 h-4 border-2 border-orange-200 dark:border-orange-500/30 border-t-orange-500 rounded-full animate-spin" />
                    ...
                    <tr key={keyId} className={`border-b border-slate-100 dark:border-white/5 transition-colors ${
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => confirm('Reset status for this key?', () => resetKey(keyId))}
                          ...
                          <button
                            onClick={() => confirm('Delete this key?', () => deleteKey(keyId))}
              ...
              return (
                <div key={keyId} className={`p-4 rounded-xl border backdrop-blur-sm ${
                  ...
                  <div className="flex gap-2 pt-3 border-t border-slate-100 dark:border-white/5">
                    <button
                      onClick={() => confirm('Reset status?', () => resetKey(keyId))}
