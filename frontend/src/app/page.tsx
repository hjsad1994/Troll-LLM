          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            ...
            <div className="group relative">
              ...
              <div className="relative p-6 sm:p-8 rounded-2xl border border-indigo-300 dark:border-indigo-500/30 bg-white dark:bg-slate-900/80 backdrop-blur-sm h-full flex flex-col shadow-md">
                ...
                <div className="mb-5 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2">
                    <span className="text-base sm:text-lg text-[var(--theme-text-subtle)] line-through">115K</span>
                    <span className="px-1.5 sm:px-2 py-0.5 rounded-md bg-orange-500/20 text-orange-600 dark:text-orange-400 text-[10px] sm:text-xs font-bold">-31%</span>
                  </div>
                  <div className="flex items-baseline gap-1">
