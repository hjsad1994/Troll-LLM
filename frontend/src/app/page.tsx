...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--theme-bg)] overflow-x-hidden">
      ...
      <div className="fixed top-[68px] left-0 right-0 z-40 bg-gradient-to-r from-indigo-500 to-purple-500 py-2 px-4">
        <div className="max-w-6xl mx-auto flex items-center justify-center gap-2 text-white text-sm">
          ...
          <a href="https://discord.gg/Prs3RxwnyQ" target="_blank" rel="noopener noreferrer" className="font-semibold underline underline-offset-2 hover:no-underline">
            {t.banner.joinNow}
          </a>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="flex justify-start mb-6 opacity-0 animate-fade-in-up">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5">
                  ...
                  <span className="text-[var(--theme-text-muted)] text-sm">{t.hero.badge}</span>
                </div>
              </div>
              ...
              <p className="text-lg text-[var(--theme-text-subtle)] mb-8 opacity-0 animate-fade-in-up animation-delay-200">
                {t.hero.description}
              </p>

              {/* CTA Buttons */}
              <div className="opacity-0 animate-fade-in-up animation-delay-300">
                <a href="https://discord.gg/Prs3RxwnyQ" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-[#5865F2] text-white font-medium hover:bg-[#4752C4] transition-colors">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[var(--theme-text)] mb-2">
                  <AnimatedCounter value={stat.value} suffix={stat.suffix} />
                </div>
                <div className="text-[var(--theme-text-subtle)] text-sm uppercase tracking-wider">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-[var(--theme-text)] mb-2">{feature.title}</h3>
      ...
      <section id="pricing" className="py-24 border-t border-black/5 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[var(--theme-text-muted)] max-w-xl mx-auto">
              {t.pricing.subtitle}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 rounded-2xl border border-black/10 dark:border-white/10 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm hover:border-black/20 dark:hover:border-white/20 transition-all duration-300 h-full flex flex-col">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 mb-3">
                      <svg className="w-4 h-4 text-[var(--theme-text-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                      </svg>
                      <span className="text-[var(--theme-text-muted)] text-xs font-medium">{t.pricing.dev.badge}</span>
                    </div>
                    <h3 className="text-2xl font-bold text-[var(--theme-text)]">{t.pricing.dev.name}</h3>
                    <p className="text-[var(--theme-text-subtle)] text-sm mt-1">{t.pricing.dev.description}</p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-lg text-[var(--theme-text-subtle)] line-through">49K</span>
                    <span className="px-2 py-0.5 rounded-md bg-orange-500/20 text-orange-600 dark:text-orange-400 text-xs font-bold">-29%</span>
                  </div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-5xl font-bold text-[var(--theme-text)]">35K</span>
                    <span className="text-[var(--theme-text-subtle)] text-lg">VND</span>
                    <span className="text-[var(--theme-text-subtle)] text-sm">/month</span>
                  </div>
                  <p className="text-emerald-500 dark:text-emerald-400 text-sm font-medium mt-2">{t.pricing.dev.save}</p>
                </div>
                ...
                {/* CTA */}
                <a href="https://discord.gg/Prs3RxwnyQ" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl border border-black/10 dark:border-white/10 text-[var(--theme-text)] font-medium text-center hover:bg-black/5 dark:hover:bg-white/5 hover:border-black/20 dark:hover:border-white/20 transition-all duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/>
                  </svg>
                  {t.pricing.dev.cta}
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 rounded-2xl border border-indigo-500/30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm h-full flex flex-col">
                ...
                <div className="flex items-start justify-between mb-6 mt-2">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-500/30 mb-3">
                      ...
                      <span className="text-indigo-500 dark:text-indigo-400 text-xs font-medium">{t.pricing.pro.badge}</span>
                    </div>
                    <h3 className="text-2xl font-bold text-[var(--theme-text)]">{t.pricing.pro.name}</h3>
                    <p className="text-[var(--theme-text-subtle)] text-sm mt-1">{t.pricing.pro.description}</p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-lg text-[var(--theme-text-subtle)] line-through">115K</span>
                    <span className="px-2 py-0.5 rounded-md bg-orange-500/20 text-orange-600 dark:text-orange-400 text-xs font-bold">-31%</span>
                  </div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-5xl font-bold text-[var(--theme-text)]">79K</span>
                    <span className="text-[var(--theme-text-subtle)] text-lg">VND</span>
                    <span className="text-[var(--theme-text-subtle)] text-sm">/month</span>
                  </div>
                  <p className="text-emerald-500 dark:text-emerald-400 text-sm font-medium mt-2">{t.pricing.pro.save}</p>
                </div>
                ...
                {/* CTA */}
                <a href="https://discord.gg/Prs3RxwnyQ" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-[#5865F2] text-white font-semibold text-center hover:bg-[#4752C4] transition-all duration-300 shadow-md shadow-[#5865F2]/20">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/>
                  </svg>
                  {t.pricing.pro.cta}
          ...
          <div className="text-center mt-8">
            <Link href="/models" className="inline-flex items-center gap-2 text-[var(--theme-text-subtle)] hover:text-[var(--theme-text)] transition-colors text-sm">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors"
                >
                  <span className="text-[var(--theme-text)] text-sm font-medium">{faq.question}</span>
                  <svg
                    className={`w-4 h-4 text-[var(--theme-text-subtle)] transition-transform duration-200 ${openFaq === index ? 'rotate-180' : ''}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className={`overflow-hidden transition-all duration-200 ${openFaq === index ? 'max-h-40' : 'max-h-0'}`}>
                  <div className="px-5 pb-4">
                    <p className="text-[var(--theme-text-subtle)] text-sm leading-relaxed">{faq.answer}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-24 border-t border-black/5 dark:border-white/5 relative">
        ...
        <div className="relative max-w-2xl mx-auto px-6 text-center">
          ...
          <Link href="/docs" className="inline-block px-8 py-4 rounded-xl bg-[var(--theme-text)] text-[var(--theme-bg)] font-semibold text-lg hover:opacity-90 transition-colors">
            {t.cta.button}
          </Link>
        </div>
      </section>
