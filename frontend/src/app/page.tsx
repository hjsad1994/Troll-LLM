          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="opacity-0 animate-fade-in-up animation-delay-300">
                <a href="#pricing" className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-medium hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 transition-all text-sm sm:text-base shadow-lg shadow-purple-500/25">
                  {t.hero.cta}
      ...
      <section id="pricing" className="py-20 sm:py-28 border-t border-gray-200 dark:border-white/5">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="p-8 sm:p-10 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/[0.02]">
            ...
            <Link
              href="/checkout"
              className="block w-full py-3.5 rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-semibold text-center hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 transition-all shadow-lg shadow-purple-500/25"
            >
              {t.pricing.buyNow}
            </Link>
