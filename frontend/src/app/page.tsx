          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900/50 backdrop-blur-sm hover:border-gray-300 dark:hover:border-white/20 transition-all duration-300 h-full flex flex-col shadow-sm">
                ...
                {/* CTA */}
                <Link href="/checkout?plan=dev" className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-indigo-500 text-white font-semibold text-center hover:bg-indigo-600 transition-all duration-300 shadow-md shadow-indigo-500/20">
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 rounded-2xl border border-indigo-300 dark:border-indigo-500/30 bg-white dark:bg-slate-900/80 backdrop-blur-sm h-full flex flex-col shadow-md">
                ...
                {/* CTA */}
                <Link href="/checkout?plan=pro" className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold text-center hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-md shadow-indigo-500/20">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                  </svg>
                  {t.pricing.buyNow}
