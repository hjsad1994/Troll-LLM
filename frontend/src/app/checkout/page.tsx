          ...
          <div className="space-y-8">
            ...
            <div className="p-5 rounded-xl bg-white dark:bg-white/5 border border-slate-400/80 dark:border-white/10 shadow-sm dark:shadow-none">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 text-xs">
                ...
                <a href="https://discord.gg/WA3NzpXuq9" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-[#5865F2] text-white hover:bg-[#4752C4] transition-colors shadow-sm">
