...
function CheckoutContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-black">
      {/* Header */}
      <header className="border-b border-gray-200 dark:border-white/5 bg-white/80 dark:bg-black/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className={language === 'vi' ? 'text-gray-900 dark:text-white font-medium' : 'text-gray-500 dark:text-gray-400'}>VI</span>
              <span className="text-gray-400">/</span>
              <span className={language === 'en' ? 'text-gray-900 dark:text-white font-medium' : 'text-gray-500 dark:text-gray-400'}>EN</span>
            </button>
            {/* Theme Switch */}
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg border border-gray-300 dark:border-white/10 hover:border-gray-400 dark:hover:border-white/20 hover:bg-black/5 dark:hover:bg-white/5 transition-all"
            ...
            {/* Close */}
            <Link href="/" className="p-2 text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        {step === 'select' && (
          <div className="space-y-8">
            ...
            <div className="relative group">
              ...
              {/* Card Content */}
              <div className="relative p-6 rounded-[14px] bg-white dark:bg-gray-900">
                {plan.popular && (
            ...
            <div className="p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm placeholder-gray-400 focus:outline-none focus:border-[#5865F2] transition-colors"
                maxLength={19}
              />
              <div className="mt-3 flex flex-wrap items-center gap-2 text-xs">
                <a href="https://support.discord.com/hc/en-us/articles/206346498" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  {t.checkout.discord.howToFind}
                </a>
                <a href="https://discord.gg/Prs3RxwnyQ" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-[#5865F2] text-white hover:bg-[#4752C4] transition-colors">
            ...
            <div className="bg-white dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/10 p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 dark:text-white">
                    {formatPrice(plan.price)} <span className="text-lg font-normal text-gray-500">VND</span>
                  </p>
                </div>
                <div className="text-right">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold text-lg hover:from-indigo-600 hover:to-purple-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
          ...
          <div className="max-w-2xl mx-auto min-h-[60vh] flex items-center pt-[10vh]">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-shrink-0 text-center">
                ...
                <p className="text-xs text-red-500 dark:text-red-400 mt-2">{t.checkout.payment.exactAmount}</p>
                <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full mt-3 ${
                  remainingSeconds < 60 ? 'bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400' : 'bg-green-100 dark:bg-green-500/20 text-green-600 dark:text-green-400'
                }`}>
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-500/10 rounded-xl p-3 flex items-start gap-3">
        ...
        {step === 'success' && (
          <div className="max-w-md mx-auto text-center space-y-6">
            {/* Success Icon */}
            <div className="w-24 h-24 mx-auto rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center">
            ...
            {/* Discord Role Status */}
            {discordRoleAssigned && (
              <div className="bg-[#5865F2]/10 rounded-xl p-4 flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-indigo-500 text-white font-semibold text-lg hover:bg-indigo-600 transition-colors shadow-lg hover:shadow-xl"
            >
