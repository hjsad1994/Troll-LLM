...
export default function KiloCodePage() {
        ...
        <main className="flex-1 min-w-0 px-6 lg:px-12 py-12">
          <div className="max-w-3xl">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-slate-500 mb-8">
              ...
              <span>/</span>
              <span className="text-gray-700 dark:text-slate-400">Kilo Code</span>
            </div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white">{t.docs.integrations.kiloCode.title}</h1>
                <p className="text-gray-500 dark:text-slate-500">{t.docs.integrations.kiloCode.subtitle}</p>
              </div>
            </div>
            ...
            {/* Prerequisites */}
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">{t.docs.integrations.kiloCode.prerequisites}</h2>
            <ul className="list-disc list-inside text-gray-600 dark:text-slate-400 space-y-2 mb-8">
              ...
              <li>{t.docs.integrations.kiloCode.prereq3} (<Link href="/register" className="text-sky-600 dark:text-sky-400 hover:underline">{t.docs.integrations.kiloCode.getOneHere}</Link>)</li>
            </ul>

            {/* Configuration Steps */}
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-6">{t.docs.integrations.kiloCode.configuration}</h2>

            <div className="mt-6">
              <Step number={1} title={t.docs.integrations.kiloCode.step1Title}>
                <p className="mb-4">
                  {t.docs.integrations.kiloCode.step1Desc} (<code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white text-sm">Cmd/Ctrl + Shift + P</code>) {t.docs.integrations.kiloCode.step1Search} <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white text-sm">Kilo Code: Open Settings</code>.
                </p>
              </Step>

              <Step number={2} title={t.docs.integrations.kiloCode.step2Title}>
                <p className="mb-4">
                  {t.docs.integrations.kiloCode.step2Desc}
                </p>
                <CodeBlock
  ...
  "kilocode.model": "claude-sonnet-4-5"
              ...
              <Step number={3} title={t.docs.integrations.kiloCode.step3Title}>
                <p className="mb-4">
                  {t.docs.integrations.kiloCode.step3Desc}
                </p>
                <div className="space-y-3 mb-4">
                  <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                    ...
                    <span className="text-gray-500 dark:text-slate-500 ml-2">— {t.docs.integrations.kiloCode.modelOpusDesc}</span>
                  </div>
                  <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                    <code className="text-sky-600 dark:text-sky-400">claude-sonnet-4-5</code>
                    <span className="text-gray-500 dark:text-slate-500 ml-2">— {t.docs.integrations.kiloCode.modelSonnetDesc}</span>
                  </div>
                  <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                    <code className="text-amber-600 dark:text-amber-400">claude-haiku-4-5</code>
                    <span className="text-gray-500 dark:text-slate-500 ml-2">— {t.docs.integrations.kiloCode.modelHaikuDesc}</span>
                  </div>
                </div>
              </Step>

              <Step number={4} title={t.docs.integrations.kiloCode.step4Title}>
                <p className="mb-4">
                  {t.docs.integrations.kiloCode.step4Desc} <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white text-sm">Cmd/Ctrl + K</code> {t.docs.integrations.kiloCode.step4Open}
                </p>
              </Step>
            </div>

            <Note>
              {t.docs.integrations.kiloCode.noteCredits} <Link href="/dashboard" className="text-sky-600 dark:text-sky-400 hover:underline">{t.docs.integrations.kiloCode.dashboard}</Link>.
            </Note>

            {/* Troubleshooting */}
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">{t.docs.integrations.kiloCode.troubleshooting}</h2>
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                <h3 className="text-gray-900 dark:text-white font-medium mb-2">{t.docs.integrations.kiloCode.connRefused}</h3>
                <p className="text-gray-600 dark:text-slate-400 text-sm">{t.docs.integrations.kiloCode.connRefusedDesc} <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-800 dark:text-slate-300">https://chat.trollllm.xyz/v1</code> {t.docs.integrations.kiloCode.withNoTrailing}</p>
              </div>
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                <h3 className="text-gray-900 dark:text-white font-medium mb-2">{t.docs.integrations.kiloCode.invalidKey}</h3>
                <p className="text-gray-600 dark:text-slate-400 text-sm">{t.docs.integrations.kiloCode.invalidKeyDesc}</p>
              </div>
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5">
                <h3 className="text-gray-900 dark:text-white font-medium mb-2">{t.docs.integrations.kiloCode.modelNotFound}</h3>
                <p className="text-gray-600 dark:text-slate-400 text-sm">{t.docs.integrations.kiloCode.modelNotFoundDesc} <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-800 dark:text-slate-300">claude-opus-4-5</code>, <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-800 dark:text-slate-300">claude-sonnet-4-5</code>, <code className="px-1 py-0.5 rounded bg-gray-100 dark:bg-white/10 text-gray-800 dark:text-slate-300">claude-haiku-4-5</code>.</p>
              </div>
            </div>

            {/* Footer navigation */}
            <div className="flex items-center justify-between mt-16 pt-8 border-t border-gray-200 dark:border-white/5">
              <Link href="/docs/api/streaming" className="group flex items-center gap-2 text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                <svg className="w-4 h-4 group-hover:-translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
                <span>Streaming</span>
              </Link>
              <Link href="/docs/integrations/roo-code" className="group flex items-center gap-2 text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                <span>Roo Code</span>
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <aside className="hidden xl:block w-56 flex-shrink-0 sticky top-[65px] h-[calc(100vh-65px)] overflow-y-auto border-l border-gray-200 dark:border-white/5 p-6">
          ...
          <nav className="space-y-2">
            <a href="#" className="block text-sm text-gray-900 dark:text-white">Kilo Code</a>
            ...
            <a href="#" className="block text-sm text-gray-500 dark:text-slate-500 hover:text-gray-900 dark:hover:text-white transition-colors pl-3">1. Open Settings</a>
            <a href="#" className="block text-sm text-gray-500 dark:text-slate-500 hover:text-gray-900 dark:hover:text-white transition-colors pl-3">2. Configure Provider</a>
            <a href="#" className="block text-sm text-gray-500 dark:text-slate-500 hover:text-gray-900 dark:hover:text-white transition-colors pl-3">3. Select Model</a>
            <a href="#" className="block text-sm text-gray-500 dark:text-slate-500 hover:text-gray-900 dark:hover:text-white transition-colors pl-3">4. Test Connection</a>
