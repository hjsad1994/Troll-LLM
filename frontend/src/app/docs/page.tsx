          ...
          <div className="mt-8 p-4 rounded-lg bg-white/[0.02] border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="https://discord.gg/CHKnQZewkr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] text-white text-xs font-medium transition-colors">
