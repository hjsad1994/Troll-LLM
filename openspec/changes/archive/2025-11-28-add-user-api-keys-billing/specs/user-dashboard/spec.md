...
- **THEN** monthly token limit SHALL be 100,000
- **AND** total token quota SHALL be 500,000

#### Scenario: Pro plan limits
- **WHEN** user has plan "pro"
- **THEN** monthly token limit SHALL be 1,000,000
- **AND** total token quota SHALL be 10,000,000

#### Scenario: Enterprise plan limits
- **WHEN** user has plan "enterprise"
- **THEN** monthly token limit SHALL be 10,000,000
- **AND** total token quota SHALL be unlimited (represented as -1)
