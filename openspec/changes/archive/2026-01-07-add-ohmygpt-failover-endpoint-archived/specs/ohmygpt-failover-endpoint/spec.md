...
Enable admin-configurable failover endpoint support for OhMyGPT API keys, allowing selected keys to automatically switch to a backup endpoint when encountering quota exhaustion or permanent blocking errors, instead of being rotated out of the pool.
