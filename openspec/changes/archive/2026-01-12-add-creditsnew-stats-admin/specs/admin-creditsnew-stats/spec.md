...
## Purpose
Display aggregate OpenHands credit statistics (`creditsNew` and `creditsNewUsed`) in the admin dashboard to provide complete visibility into both OhMyGPT and OpenHands credit systems.
